    ...
    if (type=== "text") {
        ...
        if (send===null){
            ...
            if(send===true || send==="true")
                if(tp==="a"){
                    uriz="line://app/1654347079-M5Z0NXxp/?type=sticker&tstk=animasi&stkid="+sid+"&stkpkgid="+pkg+"&send=true";
                }else{
                    uriz="line://app/1654347079-M5Z0NXxp/?type=sticker&tstk=anime&stkid="+sid+"&stkpkgid="+pkg+"&send=true";
                }
        }
        liff.sendMessages([{
          type: "template",
